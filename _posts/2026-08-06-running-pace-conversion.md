---
layout: post
title: "The quick way to see how fast you run in km and miles"
...
<table id="running-pace-conversion-table">
  <thead>
    <tr>
      <th style="text-align: center;">Kilometres Per Hour</th>
      <th style="text-align: center;">Miles Per Hour</th>
      <th style="text-align: center;">Minutes Per Kilometres</th>
      <th style="text-align: center;">Minutes Per Mile</th>
      <th style="text-align: center;">5k</th>
      <th style="text-align: center;">10k</th>
      <th style="text-align: center;">Half Marathon</th>
      <th style="text-align: center;">Marathon</th>
    </tr>
  </thead>
  <tbody id="running-pace-conversion-table-body">
    <!-- <tr>
      <td>8.00kph</td>
      <td>4.97mph</td>
      <td>7:30</td>
